...
namespace Gestler
{
    public partial class Gestler : Form
    {
        Capture CapWebCam;
        Seq<Point> Hull;
        ...
        private void Gestler_load(object sender, EventArgs e)
        {
            ...
            Application.Idle += ProcessImgAndUpdateGUI;
        }

        private void ProcessImgAndUpdateGUI(object sender, EventArgs e)
        {
            int Finger_num = 0;
            Double Result1 = 0;
            Double Result2 = 0;
            ...
            if (biggestContour != null)
            {
                ...
                FingerCount.Text = Finger_num.ToString();
            }
            ...
            GestlerBox.Image = imgOrignal;    
        }

        private void GButtonPauseorResume(object sender, EventArgs e)
        {
            if (!button_pressed)
            {
                button_pressed = true;                                              // Set Flag
                GestlerButton.Text = "Turn Off ";       // Change button text
            }
            else
            {
                GestlerButton.Text = "Turn On ";             // Change text
                button_pressed = false;                                             // Unset flag
            }
        }

        private void Gestler_Closed(object sender, FormClosedEventArgs e)
        {
            if (CapWebCam != null)
            {
                CapWebCam.Dispose();
